...
Conçu en HTML5, CSS3 vanille, et JavaScript moderne, ce projet permet de générer des plans d'implantation propres, exportables et prêts pour l'impression ou la sauvegarde en PDF au format A4/A3.
